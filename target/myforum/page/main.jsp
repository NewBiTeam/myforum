...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">生活百事通</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<!-- 			<nav class="nav navbar-nav">
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">账号：${user.useraccount}<i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i>生活消费<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<p class="f-20 text-success">欢迎使用生活百事通</p>
				<!-- <span class="f-14"></span> -->
			<p>上次登录IP：222.35.131.79.1  上次登录时间：2014-6-14 11:19:55</p>
		<div id="cc" class="easyui-layout"
			style="width: 100%; height: 670px;">
			<div data-options="region:'center'"
				style="padding: 5px;border-style: none;"></div>
		</div>
		
</article>
		<footer class="footer">
			<p>感谢使用 生活百事通<br>&copy;2017-06-26 生活百事通<br> 本系统由<a href="http://www.h-ui.net/" target="_blank" title="H-ui前端框架">MCj</a>提供前端技术支持</p>
</footer>
</div>
</section>
<!--/此乃百度统计代码，请自行删除-->
